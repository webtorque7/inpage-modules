...
class RelatedPagesModule extends ContentModule
{
    ...
    public function onBeforeWrite()
    {
        ...
        if (isset($_REQUEST['NewPage'])) {
            $newID = (int)$_REQUEST['NewPage'];
        } elseif (isset($_REQUEST['ContentModule'][$this->ID]['NewPage'])) {
            $newID = (int)$_REQUEST['ContentModule'][$this->ID]['NewPage'];
        }
    ...
    public function Layout()
    {
        if ($layout = Personalisation::get_layout_setting()) {
            if ($layout == Personalisation::LAYOUT_TILE) {
                return 'Tile';
            } elseif ($layout == Personalisation::LAYOUT_LIST) {
                return 'List';
            }
        }
