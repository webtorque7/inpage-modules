...
class ContentModule extends DataObject implements PermissionProvider
{
	...
	public function canView($member = null) {
		...
		// admin override
		if ($member && Permission::checkMember($member, array("ADMIN", "CONTENT_MODULE_VIEW"))) return true;
	...
	public function canCreate($member = null) {
		...
		if ($member && Permission::checkMember($member, array('ADMIN', 'CONTENT_MODULE_CREATE'))) return true;
	...
	public function canEdit($member = null) {
		...
		if ($memberID && Permission::checkMember($memberID, array("ADMIN", "CONTENT_MODULE_EDIT"))) return true;
	...
	public function canPublish($member = null) {
		...
		if ($member && Permission::checkMember($member, array('CONTENT_MODULE_PUBLISH'))) return true;
