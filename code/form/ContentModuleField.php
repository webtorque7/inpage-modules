                        ...
                        if (is_subclass_of($moduleType, 'ContentModule')) {
                                ...
                                if ($record = $this->getRecord()) {
                                        ...
                                        if ($existingModules->count()) {
                                                ...
                                                $not = 'AND "ContentModule"."ID" NOT IN (' . implode(',', array_keys($existingModules->map()->toArray())) . ')';
                                        }
                                }
	                        ...
	                        $module->setCurrentModuleField($this);
                                if (!empty($_REQUEST['ContentModule'][$id])) {
                                        ...
                                        foreach ($fields as $field => $type) {
                                                if ($type == 'Boolean' && !isset($_REQUEST['ContentModule'][$id][$field])) {
                                                        $_REQUEST['ContentModule'][$id][$field] = false;
                                                }
                                        }

                                        $message = $module->{$method}($_REQUEST['ContentModule'][$id]);
                                }
                                else {
